...
namespace Signtelecom.ESRI.Shapefile.Record
{
    class ShapePolyLineZ : Shape
    {
        ...
        private enum DataLocation
        {
            ...
            ShapeType   = 0x0000,   // Byte 0       Shape Type  13          Integer     1           Little
        ...
        public ShapePolyLineZ(List<byte> MetaData, bool UnusedZ = true, bool UnusedM = true)
        {
